    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            //callDAO("Add");
            Boolean flag = false,mobflag=false;
   ...
   */
    ...
    public Boolean mobilevalidate(){
        ...
        if (mobile.length()>10 || mobile.length()<10)
            JOptionPane.showMessageDialog(new JFrame(), "Mobile Number must contain 10 Numbers","Inane error", JOptionPane.ERROR_MESSAGE);
        else 
            valid = true;
        return valid;
    }
    ...
    private void openDelete(){
     ...
     private void openSearch(){ 
         String s=JOptionPane.showInputDialog(null,"Enter the search name","search",1);
